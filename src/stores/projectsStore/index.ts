...
//   const projectsByClient = ref<ClientProjects[]>([])
...
//   }
//
//   function setProjectsByClient (value: ClientProjects[]) {
//     projectsByClient.value = value
//   }
//
//   async function searchProjectsByClient (status: ProjectStatuses, searchTerm?: string): Promise<void> {
//     isLoadingProjects.value = true
//     const query = { status: status.toUpperCase(), searchTerm }
//     const data = await api.searchProjectsByClient(query)
//     projectsByClient.value = data.value
...
//       projectsByClient.value.findIndex((client) => client.id === clientId),
//       'CLIENT_NOT_FOUND'
//     )
//
//     const client = getClientByIndex(clientIndex)
...
//     return assertIndex(
//       projectsByClient.value.findIndex((client) =>
